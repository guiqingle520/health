...
5. [Garmin 设备接入设计](./03-technical/garmin-integration.md)
...
- UI 原型：`UI/` 目录包含 App 主流程、数据趋势、AI 建议、我的页，以及 Web 工作台原型。

## 阶段路线

- Phase 1 MVP：登录、建档、饮食/运动记录、日汇总、首页仪表盘。
- Phase 2 近期增强：数据趋势、AI 建议、饮水/睡眠/用药、报告导出、个人中心完善。
- Phase 3 智能化：AI 饮食识别、自然语言记录、周报/月报、companion context 汇总。
- Phase 4 家庭与设备生态：家庭共享、Garmin 等可穿戴设备接入、医生/健康顾问视图。
